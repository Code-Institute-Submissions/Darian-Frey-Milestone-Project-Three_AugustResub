...
The Readers Corner is my third project with Code Institute to show the knowledge I have gained in Python3, Databases such as MongoDB and Frameworks like Flask.<br>
I have followed the CRUD form (Create, Read, Update, Delete) to create a web app where users can register, login, read reviews, add reviews, edit reviews, delete reviews, log out and delete their account.<br>
